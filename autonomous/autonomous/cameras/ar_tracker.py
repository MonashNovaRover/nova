...
class ArTracker(Node):
    ...
    def store_ar_coords(self, msg):
        if len(self.previous_10_tags) < 10:
            ...
            try:
                approx, true = np.load("/home/nvidia/nova_ws/src/rover/autonomous/autonomous/cameras/approx.npy").tolist(), np.load("/home/nvidia/nova_ws/src/rover/autonomous/autonomous/cameras/true.npy").tolist()
                ...
                print(approx)
                print(true)
                np.save("/home/nvidia/nova_ws/src/rover/autonomous/autonomous/cameras/approx.npy", approx)
                np.save("/home/nvidia/nova_ws/src/rover/autonomous/autonomous/cameras/true.npy", true)
            except Exception as e:
                print(approx_coord)
                print(true_coord)
                approx = np.array([approx_coord])
                true = np.array([true_coord])
                np.save("/home/nvidia/nova_ws/src/rover/autonomous/autonomous/cameras/approx.npy", np.array(approx).reshape(1, 2))
                np.save("/home/nvidia/nova_ws/src/rover/autonomous/autonomous/cameras/true.npy", np.array(true).reshape(1, 2))
            rclpy.shutdown()
