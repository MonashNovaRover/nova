...
class TemplateNode(Node):
    ...
    def construct_vectors(self):
        ...
        self.pivot_angles_rad = [
            ...
            (-1 if i % 2 == 0 else 1) *\
            # rescale to radians
            (np.pi / 2) * pivot.resolver_position / self.param_resolver_factor +\
            # Add offset
        ...
        left_wheel_vector = np.sum(self.wheel_vectors[0:2], axis=0)
        right_wheel_vector = np.sum(self.wheel_vectors[2:4], axis=0)
