...
CMDQueues = {
    TYPE_MOTOR: deque(maxlen=QUEUE_LENGTH)
        for TYPE_MOTOR in ['arm', 'sci'] 
}
            ...
            # In case of no error, get data from the can msg
                ...
                if can_msg:
                    ...
                    try:
                        ...
                        continue
                    if motor_type == MotorType.ARM_JOINT or motor_type == MotorType.ARM_EE:
                    ...
                    if motor_type == MotorType.ARM_EE:
                        ros_msg.vel = 0.
                        bus = 1
