...
buildRosPackage rec {
  ...
  src = fetchurl {
    ...
    x86_64-linux = {
      url = "http://packages.ros.org/ros2/ubuntu/pool/main/r/ros-jazzy-depthai/ros-jazzy-depthai_${version}-1noble.20250102.150449_amd64.deb";
      hash = "sha256-vUybJBr3QPwqZo7lvkbgV+0PwQNezbmJrxOfKSM1wqk=";
    };
    aarch64-linux = {
