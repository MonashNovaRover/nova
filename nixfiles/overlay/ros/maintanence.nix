    ...
    super.rosPackages.appendDistroOverlay
      ...
      (
        rosSelf: rosSuper:
        {
          ...
          #     version = "3.2.2-r1";
          #     src = self.fetchzip {
          #       url = "https://github.com/IntelRealSense/realsense-ros-release/archive/release/jazzy/realsense2_camera/3.2.2-1.tar.gz";
          #       name = "3.2.2-1.tar.gz";
          ...
          #     version = "3.2.2-r1";
          #     src = self.fetchzip {
          #       url = "https://github.com/IntelRealSense/realsense-ros-release/archive/release/jazzy/realsense2_camera_msgs/3.2.2-1.tar.gz";
          #       name = "3.2.2-1.tar.gz";
          ...
          #     version = "3.2.2-r1";
          #     src = self.fetchzip {
          #       url = "https://github.com/IntelRealSense/realsense-ros-release/archive/release/jazzy/realsense2_description/3.2.2-1.tar.gz";
          #       name = "3.2.2-1.tar.gz";
          ...
          librealsense2 = rosSuper.librealsense2.overrideAttrs (
            ...
            }:
            {
              version = "2.48.0-r1";
              src = self.fetchzip {
                url = "https://github.com/IntelRealSense/librealsense2-release/archive/release/jazzy/librealsense2/2.48.0-1.tar.gz";
