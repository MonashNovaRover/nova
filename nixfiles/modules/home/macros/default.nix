      ...
      shellAliases =
        lib.mkMerge [
          ...
          rec {
            ...
            reolink-low = "ffplay -rtsp_transport udp -i rtsp://admin:***REMOVED***@10.0.1.100:554/Preview_01_sub -flags low_delay -fflags nobuffer -framedrop -rc_lookahead 0 -probesize 32 -analyzeduration 0 -vf setpts=0 -tune zerolateny";
            reolink-high = "ffplay -rtsp_transport udp -i rtsp://admin:***REMOVED***@10.0.1.100:554/Preview_01_main -flags low_delay -fflags nobuffer -framedrop -rc_lookahead 0 -probesize 32 -analyzeduration 0 -vf setpts=0 -tune zerolateny";
