    ...
    home = {
      shellAliases = lib.mkMerge [
        ...
        rec {
          ...
          # Tile server
          tileserver-build = "nix-build -I nixpkgs=https://github.com/NixOS/nixpkgs/archive/173b74db07f26344f3517716edd4bff6987b512d.tar.gz -E 'with import <nixpkgs> { }; callPackage ~/nova/nixfiles/packages/other/tileserver-gl-shell { }' -o ~/nova/src/ros/nova-gui/tileserver-gl-shell";
          tileserver-shell = "~/nova/src/ros/nova-gui/tileserver-gl-shell/bin/tileserver-gl-fhs";
