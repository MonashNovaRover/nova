      ...
      shellAliases =
        lib.mkMerge [
          ...
          rec {
            ...
            cameras-legacy = './gst-nova-launcher ros2 launch cameras2 camera_server_launch.py platform:=rover param-dir:="$HOME/nova/src/ros/cameras2/cameras2/params" autostart:=true payload:=arm'
          }
        ];
