    ...
    programs.bash = {
      bashrcExtra = lib.mkAfter ''
        ...
        [[ $- == *i* ]] && (
          ...
          bob3="$yellow\u2588$grey\u2588$white\u2588$black\u2588$grey\u2588$white\u2588$black\u2588$grey\u2588$yellow\u2588$end"
          bob4="$yellow\u2588\u2588$grey\u2588\u2588$yellow\u2588$grey\u2588\u2588$yellow\u2588\u2588$end"
          bob5="$blue\u2588$yellow\u2588\u2588\u2588\u2588\u2588\u2588\u2588$blue\u2588$end"
          bob6="$yellow\u2588$blue\u2588$yellow\u2588\u2588\u2588\u2588\u2588$blue\u2588$yellow\u2588$end"
          
          printf " $bob0 ┌$border┐\n"
          printf " $bob1 │ $cyan%-$((width-1))s$end│\n" "$title"
          printf " $bob2 │ $magenta%s$end%s%-$((width-1-''${#help_label}-''${#help_value}))s│\n" "$help_label" "$help_value" ""
          printf " $bob3 │   $yellow%s$end%s%-$((width-3-''${#rmw_label}-''${#rmw_value}))s│\n" "$rmw_label" "$rmw_value" ""
          printf " $bob4 │   $yellow%s$end%s%-$((width-3-''${#comp_label}-''${#comp_value}))s│\n" "$comp_label" "$comp_value" ""
          printf " $bob5 │   $yellow%s$end%s%-$((width-3-''${#build_label}-''${#build_value}))s│\n" "$build_label" "$build_value" ""
          printf " $bob6 └$border┘"
          echo   ""
        )
