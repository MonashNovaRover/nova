...
public:
  ...
  SpeedLimiter(
    ...
    const bool has_jerk_limits = false, const double min_velocity = NAN,
    const double max_velocity = NAN, const double min_acceleration = NAN,
    const double max_acceleration = NAN, const double min_jerk = NAN, const double max_jerk = NAN)
   ...
   */
  double limit(double& v, const double v0, const double v1, const double dt) const
  {
    const double tmp = v;
   ...
   * \return Limiting factor (1.0 if none)
   */
  double limit_acceleration(double& v, const double v0, const double dt) const
  {
    const double tmp = v;
   ...
   */
  double limit_jerk(double& v, const double v0, const double v1, const double dt) const
  {
    const double tmp = v;
