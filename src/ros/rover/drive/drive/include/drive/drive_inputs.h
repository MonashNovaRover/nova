...
private:
    ...
    rclcpp::Subscription<input_interfaces::msg::InputGamepad>::SharedPtr gamepad_input_subscription;
...
private:
    ...
    void input_callback (const input_interfaces::msg::InputGamepad::SharedPtr msg);
