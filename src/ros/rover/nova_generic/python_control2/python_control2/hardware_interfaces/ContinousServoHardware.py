"""
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Hardware interface for continous servo motors.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
COMMAND INTERFACES:
...
class ContinousServoHardware(HardwareInterface):
    ...
    def __init__(self, contexts: Contexts,
        ...
        self.declare_parameter("can_id", can_id, "CAN ID of the ContinousServo")
    ...
    def on_configure(self, command_interfaces: InterfaceCollection, state_interfaces: InterfaceCollection):
        ...
        if not self.effort_cmd:
            self.logger.warn(f"ContinousServo \"{self.name}\" has no populated command interfaces. "
                             f"(\"{self.joint}/effort\")")
