...
def launch_setup(context, *args, **kwargs):
    ...
    return [
        ...
        Node(
            ...
            name='yolo_ros_node',
            namespace=namespace,
            parameters=[{'model': yolo_model, 'use_sim_time': sim}, yolo_params],
        ...
        Node(
            ...
            namespace=namespace,
            parameters=[yolo_params, {'use_sim_time': sim}],
            remappings=[('image_raw', rgb_image), 
        ...
        Node(
            ...
            parameters=[{'using_oak': using_oak, 'using_3d': using_3d, 'use_sim_time': sim}, yolo_params],
            namespace=namespace,
        ),
    ]
