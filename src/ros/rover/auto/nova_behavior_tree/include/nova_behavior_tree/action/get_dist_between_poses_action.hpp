 ...
 */
class GetDistBetweenPosesAction : public BT::ConditionNode
{
public:
  /**
   * @brief A constructor for nova_behavior_tree::GetDistBetweenPosesAction
   * @param condition_name Name for the XML tag for this node
   * @param conf BT node configuration
   */
  GetDistBetweenPosesAction(
    const std::string & condition_name,
    const BT::NodeConfiguration & conf);

  GetDistBetweenPosesAction() = delete;

  /**
   * @brief A destructor for nova_behavior_tree::GetDistBetweenPosesAction
   */
  ~GetDistBetweenPosesAction() override = default;
  ...
  /**
   * @brief Get the distance between the two provided poses
   * @return Distance between the two provided poses
   */
  double getDist();
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<double>("dist", "Distance between ref_pose and target_pose"),
    };
  }
