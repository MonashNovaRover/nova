...
class TrackingCamera(Node):
    ...
    def get_next_pose(self):
        ...
        if pose:
            ...
            sys.stdout.write("\r" + "x: " + str(round(rover_msg.x, 4)).ljust(7)
                             ...
                             + " | odom: " + str(self.wheel_velocity).ljust(7))
    ...
    def send_wheel_odom(self):
        ...
        #print("wheel odom sending: " + str(self.wheel_velocity))
        # print("updating wheel vel: " + str(self.wheel_velocity))
