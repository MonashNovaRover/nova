...
class UpdateLED(Node):
  ...
  def __init__(self):
    ...
    self.auto_active_srv = self.create_service(Trigger, 'auto_active', self.cb_auto_active)
    self.auto_success_srv = self.create_service(Trigger, 'auto_success', self.cb_auto_success)
    self.manual_active_srv = self.create_service(Trigger, 'manual_active', self.cb_manual_active)
