...
#ifndef NOVA_BT_NAVIGATORS__NAVIGATORS__URC_2025_NAVIGATOR_HPP_
#define NOVA_BT_NAVIGATORS__NAVIGATORS__URC_2025_NAVIGATOR_HPP_
...
#include "nova_interfaces/action/urc2025_navigator.hpp"
...
/**
 * @class URC2025Navigator
 * @brief A navigator for navigating to a a bunch of intermediary poses
 */
class URC2025Navigator
  : public nav2_core::BehaviorTreeNavigator<nova_interfaces::action::URC2025Navigator>
{
public:
   ...
   */
  std::string getName() override {return std::string("urc_2025_navigator");}
...
#endif  // NOVA_BT_NAVIGATORS__NAVIGATORS__URC_2025_NAVIGATOR_HPP_