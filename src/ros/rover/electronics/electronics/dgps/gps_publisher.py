...
NODE: SkytraqNode
TOPICS:
  - publisher: /gps_base/gps_data   [RoverPoseGPS]
  - publisher: /gps_base/rtcm3      [UInt8MultiArray]
SERVICES: None
ACTIONS: None
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
PACKAGE: 	electronics
...
class SkytraqNode (Node):
    def __init__ (self, com_no, baud):
        ...
        self.nmea_publisher = self.create_publisher(RoverPoseGPS, '/electronics/gps_data', 10)
        self.rtcm_publisher = self.create_publisher(UInt8MultiArray, '/gps_base/rtcm3', 10)
