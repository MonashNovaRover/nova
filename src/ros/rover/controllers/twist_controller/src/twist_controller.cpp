...
namespace twist_controller
{
    ...
    TwistController::TwistController() : controller_interface::ControllerInterface() {}

    const char * TwistController::feedback_type() const
    {
        ...
        const rclcpp::Time & time, const rclcpp::Duration & period)
    {
        ...
        received_twist_msg_ptr_.get(last_command_msg);
    ...
    double TwistController::get_pivot_angle_from_radius(float radius, bool left, int dir)
    {
    ...
    double TwistController::get_radius_from_angle(double angle, bool left) 
    {
        double radius;
    ...
    std::tuple<float,int> TwistController::get_best_effort_radius_direction(float target_radius, float target_direction) 
    {
        ...
        */
        ...
        if (publish_limited_drive_pivot_)
        {
            ...
            realtime_limited_drive_pivot_publisher_ =
              std::make_shared<realtime_tools::RealtimePublisher<geometry_msgs::msg::TwistStamped>>(limited_drive_pivot_publisher_);
        }
        */
    ...
    controller_interface::CallbackReturn TwistController::on_deactivate(
        const rclcpp_lifecycle::State &)
    {
    ...
    controller_interface::CallbackReturn TwistController::on_cleanup(
        const rclcpp_lifecycle::State &)
    {
        if (!reset())
        {
    ...
    controller_interface::CallbackReturn TwistController::on_error(const rclcpp_lifecycle::State &)
    {
        if (!reset())
        {
            return controller_interface::CallbackReturn::ERROR;
    ...
    controller_interface::CallbackReturn TwistController::on_shutdown(
        const rclcpp_lifecycle::State &)
    {
        return controller_interface::CallbackReturn::SUCCESS;
    }

    void TwistController::halt()
    {
    ...
    controller_interface::CallbackReturn TwistController::configure_drive_pivots(
