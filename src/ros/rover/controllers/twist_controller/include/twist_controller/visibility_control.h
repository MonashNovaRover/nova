...
#define TWIST_CONTROLLER_PUBLIC FOUR_STEERING_CONTROLLER_EXPORT
#else
#define TWIST_CONTROLLER_PUBLIC FOUR_STEERING_CONTROLLER_IMPORT
#endif
#define TWIST_CONTROLLER_PUBLIC_TYPE FOUR_STEERING_CONTROLLER_PUBLIC
