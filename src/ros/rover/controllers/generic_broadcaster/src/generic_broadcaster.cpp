...
controller_interface::CallbackReturn GenericBroadcaster::on_configure(
...
controller_interface::CallbackReturn GenericBroadcaster::configure_drive_pivots(
