...
#include "nova_diff_drive_controller/speed_limiter.hpp"
...
namespace nova_diff_drive_controller
{
  ...
  protected:
    ...
    rclcpp::Subscription<nova_interfaces::msg::DriveInput>::SharedPtr drive_input_unstamped_subscriber_ = nullptr;
