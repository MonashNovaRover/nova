...
This is a custom `ros2_control` hardware interface used to control the auger. It communicates directly with any active `ros2_control` controllers via the Controller Manager.
