...
def generate_launch_description():
    ...
    return LaunchDescription([      
        ...
        Node(package='arm', executable='resolver_publisher.py', parameters=[params_path / 'arm_params.yaml'], output='screen', emulate_tty=True),
        Node(package='arm', executable='arm_rviz_publisher', output='screen', emulate_tty=True),
        Node(package='electronics', executable='CMD_publisher.py', output='screen', emulate_tty=True),
    ])
