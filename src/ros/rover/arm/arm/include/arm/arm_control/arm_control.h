...
TOPICS:
  ...
  - /arm/arm_coord_frames             [sensor_msgs/MultiDOFJointState]  [Published]
...
#include "kinematics/arm_kinematics.h"
#include "arm_control/pi_controller.h"
...
class ArmControl : public rclcpp::Node
{
    ...
    // Subscribers
    rclcpp::Subscription<arm_interfaces::msg::ArmControlScheme>::SharedPtr control_scheme_sub;
    ...
    void control_scheme_callback(const arm_interfaces::msg::ArmControlScheme::SharedPtr msg);
    ...
    void arm_config_info_callback(
        const arm_interfaces::srv::ArmConfigInfo::Request::SharedPtr request,
