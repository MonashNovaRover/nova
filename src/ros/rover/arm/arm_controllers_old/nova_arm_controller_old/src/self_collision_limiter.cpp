...
std::string SelfCollisionLimiterOld::construct_srdf_fallback_string(const urdf::ModelInterfaceSharedPtr &urdf_model,
...
bool SelfCollisionLimiterOld::init(
...
bool SelfCollisionLimiterOld::on_configure(const trajectory_msgs::msg::JointTrajectoryPoint &) {
...
SelfCollisionLimiterOld::~SelfCollisionLimiterOld() {
  delete this->planning_scene_;
}

bool SelfCollisionLimiterOld::on_enforce(
...
void SelfCollisionLimiterOld::generate_allowed_collision_matrix() {
