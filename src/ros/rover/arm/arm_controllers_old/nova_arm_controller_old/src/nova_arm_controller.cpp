...
#include "nova_arm_controller_old/nova_arm_controller.hpp"
...
namespace nova_arm_controller_old
{
...
// NovaArmControllerOld::NovaArmControllerOld() : controller_interface::ChainableControllerInterface() {}

const char *NovaArmControllerOld::joint_command_type() const {
  return params_.use_position_control ? HW_IF_POSITION : HW_IF_VELOCITY;
}

controller_interface::CallbackReturn NovaArmControllerOld::on_init()
{
...
InterfaceConfiguration NovaArmControllerOld::command_interface_configuration() const
{
...
InterfaceConfiguration NovaArmControllerOld::state_interface_configuration() const {
  std::vector<std::string> conf_names;
  for (const auto &joint_name: params_.joint_names) {
...
std::vector<hardware_interface::CommandInterface> NovaArmControllerOld::on_export_reference_interfaces() {
...
controller_interface::return_type NovaArmControllerOld::update_reference_from_subscribers(const rclcpp::Time &time, const rclcpp::Duration &period) {
...
controller_interface::return_type NovaArmControllerOld::update_velocity_reference_from_subscribers() {
...
void NovaArmControllerOld::get_joint_states(trajectory_msgs::msg::JointTrajectoryPoint &current) {
...
controller_interface::return_type NovaArmControllerOld::update_and_write_commands(
...
controller_interface::CallbackReturn NovaArmControllerOld::hot_param_update() {
  auto logger = get_node()->get_logger();
...
controller_interface::CallbackReturn NovaArmControllerOld::on_configure(
...
controller_interface::CallbackReturn NovaArmControllerOld::on_activate(
    const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn NovaArmControllerOld::on_deactivate(
    const rclcpp_lifecycle::State &)
{
...
bool NovaArmControllerOld::on_set_chained_mode(bool chained_mode) {
  // This method is called when the chained mode is set.
  (void)chained_mode; // silence unused vars
  return true;
}

controller_interface::CallbackReturn NovaArmControllerOld::on_cleanup(
    const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
controller_interface::CallbackReturn NovaArmControllerOld::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return controller_interface::CallbackReturn::ERROR;
...
bool NovaArmControllerOld::reset()
{
...
controller_interface::CallbackReturn NovaArmControllerOld::on_shutdown(
    const rclcpp_lifecycle::State &)
{
  return controller_interface::CallbackReturn::SUCCESS;
}

void NovaArmControllerOld::halt()
{
...
controller_interface::CallbackReturn NovaArmControllerOld::configure_joints(
...
CLASS_LOADER_REGISTER_CLASS(
    nova_arm_controller_old::NovaArmControllerOld, controller_interface::ChainableControllerInterface)
