#ifndef NOVA_ARM_CONTROLLER_OLD__NOVA_ARM_CONTROLLER_HPP_
#define NOVA_ARM_CONTROLLER_OLD__NOVA_ARM_CONTROLLER_HPP_
...
#include "nova_arm_controller_old/self_collision_limiter.hpp"

#include <nova_arm_controller_old/nova_arm_controller_old_parameters.hpp>

namespace nova_arm_controller_old
{
class NovaArmControllerOld : public controller_interface::ChainableControllerInterface
{
public:
  //NovaArmController();
...
protected:
  ...
  SelfCollisionLimiterOld collision_limiter;
  ...
  // Parameters from ROS for nova_arm_controller_old
...
#endif // NOVA_ARM_CONTROLLER_OLD__NOVA_ARM_CONTROLLER_HPP_
