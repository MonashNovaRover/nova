#ifndef NOVA_ARM_CONTROLLER_OLD__SELF_COLLISION_LIMITER_HPP_
#define NOVA_ARM_CONTROLLER_OLD__SELF_COLLISION_LIMITER_HPP_
...
{
class SelfCollisionLimiterOld : public joint_limits::JointLimiterInterface<trajectory_msgs::msg::JointTrajectoryPoint>
{
public:
  SelfCollisionLimiterOld() = default;
  ~SelfCollisionLimiterOld();
...
#endif // NOVA_ARM_CONTROLLER_OLD__SELF_COLLISION_LIMITER_HPP_
