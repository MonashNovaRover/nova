...
#include "nova_twistmapper_old/nova_twistmapper.hpp"
...
namespace nova_twistmapper_old
{
  ...
  NovaTwistmapperOld::NovaTwistmapperOld() : controller_interface::ControllerInterface() {}

  controller_interface::CallbackReturn NovaTwistmapperOld::on_init()
  {
    try
    {
  ...
  InterfaceConfiguration NovaTwistmapperOld::command_interface_configuration() const
  {
  ...
  InterfaceConfiguration NovaTwistmapperOld::state_interface_configuration() const
  {
    std::vector<std::string> conf_names;
  ...
  Eigen::Isometry3d NovaTwistmapperOld::integrate_twist(const std::vector<double> &seed_state,
  ...
  controller_interface::return_type NovaTwistmapperOld::update(const rclcpp::Time &time, const rclcpp::Duration &period)
  {
  ...
  controller_interface::CallbackReturn NovaTwistmapperOld::on_configure(const rclcpp_lifecycle::State&)
  {
    auto logger = get_node()->get_logger();
  ...
  std::string NovaTwistmapperOld::construct_srdf_fallback_string(const urdf::ModelInterfaceSharedPtr &urdf_model,
  ...
  controller_interface::CallbackReturn NovaTwistmapperOld::on_activate(const rclcpp_lifecycle::State&)
  {
    auto logger = get_node()->get_logger();
  ...
  controller_interface::CallbackReturn NovaTwistmapperOld::on_deactivate(const rclcpp_lifecycle::State&)
  {
  ...
  controller_interface::CallbackReturn NovaTwistmapperOld::on_cleanup(const rclcpp_lifecycle::State&)
  {
  ...
  controller_interface::CallbackReturn NovaTwistmapperOld::on_error(const rclcpp_lifecycle::State&)
  {
  ...
  controller_interface::CallbackReturn NovaTwistmapperOld::on_shutdown(const rclcpp_lifecycle::State&)
  {
    return controller_interface::CallbackReturn::SUCCESS;
  }

  void NovaTwistmapperOld::halt()
  {
  ...
  void NovaTwistmapperOld::publish_to_tf2(const rclcpp::Time &time, const Eigen::Isometry3d &pose, const std::string& name) {
  ...
  controller_interface::CallbackReturn NovaTwistmapperOld::configure_joints() {
    auto logger = get_node()->get_logger();
  ...
  std::vector<double> NovaTwistmapperOld::get_state_pos_values() {
  ...
  rclcpp::Node::SharedPtr NovaTwistmapperOld::create_compat_node_from_lifecycle(
  ...
  std::string NovaTwistmapperOld::joint_to_command_interface_name(const std::string& joint_name) const {
  ...
  bool NovaTwistmapperOld::check_path_for_self_intersection(const std::vector<double> &seed_state,
  ...
  bool NovaTwistmapperOld::check_pose_for_self_intersection(const std::vector<double> &joint_positions) {
  ...
  void NovaTwistmapperOld::generate_allowed_collision_matrix() {
    auto logger = get_node()->get_logger();
...
CLASS_LOADER_REGISTER_CLASS(
    nova_twistmapper_old::NovaTwistmapperOld, controller_interface::ControllerInterface)
