...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
CONTROLLER: nova_path_planner_old/NovaPathPlannerOld
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#ifndef NOVA_PATH_PLANNER_OLD__NOVA_PATH_PLANNER_HPP_
#define NOVA_PATH_PLANNER_OLD__NOVA_PATH_PLANNER_HPP_
...
// To test in development, run from the root nova_path_planner_old dir:
// generate_parameter_library_cpp include/nova_path_planner_old/nova_path_planner_old_parameters.hpp src/nova_path_planner_old_parameter.yaml
#include "nova_path_planner_old_parameters.hpp"


namespace nova_path_planner_old
{
class NovaPathPlannerOld : public controller_interface::ControllerInterface
{
public:
...
#endif // NOVA_PATH_PLANNER_OLD__NOVA_PATH_PLANNER_HPP_
