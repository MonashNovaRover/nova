    ...
    return [
        ...
        Node(
            ...
            parameters=[{'robot_description':
                             ParameterValue(Command(['xacro ', model, ' ', 'gazebo:=', sim, ' ', 'robot_name:=', robot_name, ' ', 'arm:=', arm, ' ', 'old_arm:=', old_arm, ' ', 'use_mock_hardware:=', use_mock_hardware, ' ', 'auto_camera:=false']), value_type=str)
                         }]
        ),
        GroupAction(
