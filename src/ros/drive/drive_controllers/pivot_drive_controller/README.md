...
I've named the turning radius at which the radius of the circle made by the wheel on the side of the turn is equal the *inner radius*. When the turning radius is smaller than the inner radius, the speed is calculated as **a ratio of the zero radius**.
