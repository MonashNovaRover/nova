...
import {ActivatedNodeButtonOld} from "./ActivatedNodeButtonOld.tsx";
 ...
 */
const ActivatedNodeWidgetOld: React.FC<URCActivatedNodeWidgetProps> = (
...
export default ActivatedNodeWidgetOld;