    ...
    <div>
      ...
      {!showCalibration && <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-row gap-3">
          ...
          />
          <Button onClick={() => moveXCuvettes(visibleCuvetteInput - currentCuvette - 1)}>Go To</Button>
        </div>
        ...
        <div className="flex flex-row gap-3">
          ...
          />
          <Button onClick={() => moveXCuvettes(visSpecCuvetteInput - currentCuvette - 5 - 1)}>Go To</Button>
        </div>
      </div>}
