...
export const rosServiceMessages = {
  ...
  [RosService.CAROUSEL]: "science_interfaces/srv/SetNamedPositions",
  ...
  [RosService.CAROUSEL_TRIGGER_ZERO]: "std_srvs/srv/Trigger",
  [RosService.CAROUSEL_INCREMENT_ZERO]: "science_interfaces/srv/IncrementZero",
