...
GstElement* vp9software_pipeline(rclcpp::Node* streamer_node, vp9softwarePipelineProperties* props)
{
  ...
  if (props->crop43) RCLCPP_INFO(streamer_node->get_logger(), "Crop: %d", crop_width);
...
vp9softwarePipelineProperties* get_vp9software_pipeline_properties(rclcpp::Node* streamer_node, camera_msgs::msg::Camera* camera, const std::string pipeline_type, const std::string profile)
{
  // 0. Initialize constants
