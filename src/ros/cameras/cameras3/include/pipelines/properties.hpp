...
GstElement* vpXsoftwareGL_pipeline(rclcpp::Node* log_node, const std::unique_ptr<vpXsoftwareGLPipelineProperties>& props, const int vpX, GstContext *display_ctx, GstContext *gl_ctx);
