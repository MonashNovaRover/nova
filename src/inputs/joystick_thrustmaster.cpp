...
core::msg::InputJoystick JoystickThrustmaster::construct_message_data()
{
    ...
    new_msg.ax_stick_x = stick_ly_f;
    new_msg.ax_stick_y = -stick_lx_f;
    ...
    new_msg.ax_thumb_x = to_int(-convert_trg2ax(GamepadTriggerLength(controller, TRIGGER_RIGHT)));
    new_msg.ax_thumb_y = stick_ry_f;
